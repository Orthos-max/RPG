...
static var DATA: Dictionary = {
	...
	Id.GRANDMASTER: {
		...
		"is_promoted": true,
		"flying": false,
		"skills": [{"id": "focus", "level": 1}, {"id": "jolt", "level": 6},
			{"id": "luna", "level": 8}],
	},
	Id.BRIGAND: {
		"name": "Brigand",
	...
	Id.DARK_MAGE: {
		...
		"is_promoted": false,
		"flying": false,
		"skills": [{"id": "serenity", "level": 4}, {"id": "venom", "level": 6}],
	},
	Id.SORCERER: {
		"name": "Sorcerer",
	...
	Id.GREAT_KNIGHT: {
		...
		"is_promoted": true,
		"flying": false,
		"skills": [{"id": "bulwark", "level": 1}, {"id": "guardian", "level": 1},
			{"id": "cold_blood", "level": 4}, {"id": "charge", "level": 8}],
	},
	Id.PEGASUS_KNIGHT: {
		"name": "Pegasus Knight",
